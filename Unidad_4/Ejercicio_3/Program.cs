...
class Program
{
    static void Main(string[] args)
    {
        ...
        */
        ...
        Console.WriteLine("Ingrese el numero de procesador que quiere: ");
        procesador = int.Parse(Console.ReadLine());
        Console.WriteLine("Ingrese el numero de memoria que quiere: ");
        memoria = int.Parse(Console.ReadLine());
        Console.WriteLine("Ingrese la opcion de disco que quiere: ");
